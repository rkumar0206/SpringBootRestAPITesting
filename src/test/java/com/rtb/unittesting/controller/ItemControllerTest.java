...
public class ItemControllerTest {
	...
	public void dummyItem_basic() throws Exception {
		...
		MvcResult result = mockMvc.perform(request).andExpect(status().isOk()) // we can also use status().is(200)
				.andReturn();

		String contentString = result.getResponse().getContentAsString();

		assertEquals("{\"id\":1,\"name\":\"Ball\",\"price\":10,\"quantity\":100,\"value\":0}", contentString);
	}
	...
	public void itemFromBusinessService_basic() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.get("/item-from-buiseness-service")
		...
		JSONAssert.assertEquals("{id: 2,name:Item2,price:10,quantity:10}", contentString, false);
	}
	...
	public void retriveAllItems_basic() throws Exception {
		...
		JSONAssert.assertEquals("[{id: 2,name:Item2,price:10,quantity:10},{id: 3,name:Item3,price:20,quantity:20}]", contentString, false);
	}
}
